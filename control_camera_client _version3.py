...
GIMBAL_PHOTOS: List[Dict[str, Optional[float]]] = [
    {"pitch": -6.3, "yaw": -81.5, "yaw360": 278.5, "zoom": 20},
    {"pitch": -6.3, "yaw": -81.5, "yaw360": 278.5, "zoom": 20},

    {"pitch": -8.0, "yaw": -80.5, "yaw360": 279.5, "zoom": 20},
    {"pitch": -8.0, "yaw": -80.5, "yaw360": 279.5, "zoom": 20},

    {"pitch": -10.4, "yaw": -79.8, "yaw360": 280.2, "zoom": 20},
    {"pitch": -10.4, "yaw": -79.8, "yaw360": 280.2, "zoom": 20},

    {"pitch": -13.7, "yaw": -78.8, "yaw360": 281.2, "zoom": 10},
    {"pitch": -13.7, "yaw": -78.8, "yaw360": 281.2, "zoom": 10},

    {"pitch": -17.3, "yaw": -77.5, "yaw360": 282.5, "zoom": 10},
    {"pitch": -17.3, "yaw": -77.5, "yaw360": 282.5, "zoom": 10},

    {"pitch": -23.2, "yaw": -73.6, "yaw360": 286.4, "zoom": 5},
    {"pitch": -23.2, "yaw": -73.6, "yaw360": 286.4, "zoom": 5},

    {"pitch": -24.8, "yaw": -73.6, "yaw360": 286.4, "zoom": 5},
    {"pitch": -24.8, "yaw": -73.6, "yaw360": 286.4, "zoom": 5},

    {"pitch": -31.4, "yaw": -68.6, "yaw360": 291.4, "zoom": 2},
    {"pitch": -31.4, "yaw": -68.6, "yaw360": 291.4, "zoom": 2},

    {"pitch": -44.3, "yaw": -57.3, "yaw360": 302.7, "zoom": 2},
    {"pitch": -44.3, "yaw": -57.3, "yaw360": 302.7, "zoom": 2},

    {"pitch": -54.9, "yaw": -37.1, "yaw360": 322.9, "zoom": 2},
    {"pitch": -54.9, "yaw": -37.1, "yaw360": 322.9, "zoom": 2},

    {"pitch": -54.9, "yaw": -34.0, "yaw360": 326.0, "zoom": 2},
    {"pitch": -54.9, "yaw": -34.0, "yaw360": 326.0, "zoom": 2},

    {"pitch": -60.5, "yaw": -10.1, "yaw360": 349.9, "zoom": 2},
    {"pitch": -60.5, "yaw": -10.1, "yaw360": 349.9, "zoom": 2},

    {"pitch": -58.9, "yaw": 29.7, "yaw360": 29.7, "zoom": 2},
    {"pitch": -58.9, "yaw": 29.7, "yaw360": 29.7, "zoom": 2},

    {"pitch": -35.8, "yaw": 68.7, "yaw360": 68.7, "zoom": 5},
    {"pitch": -35.8, "yaw": 68.7, "yaw360": 68.7, "zoom": 5},

    {"pitch": -25.1, "yaw": 76.3, "yaw360": 76.3, "zoom": 10},
    {"pitch": -25.1, "yaw": 76.3, "yaw360": 76.3, "zoom": 10},

    {"pitch": -16.7, "yaw": 81.8, "yaw360": 81.8, "zoom": 10},
    {"pitch": -16.7, "yaw": 81.8, "yaw360": 81.8, "zoom": 10},

    {"pitch": -10.8, "yaw": 84.6, "yaw360": 84.6, "zoom": 20},
    {"pitch": -10.8, "yaw": 84.6, "yaw360": 84.6, "zoom": 20},

    {"pitch": -10.5, "yaw": 84.6, "yaw360": 84.6, "zoom": 20},
    {"pitch": -10.5, "yaw": 84.6, "yaw360": 84.6, "zoom": 20},

    {"pitch": -8.7, "yaw": 85.2, "yaw360": 85.2, "zoom": 40},
    {"pitch": -8.7, "yaw": 85.2, "yaw360": 85.2, "zoom": 40},

    {"pitch": -7.1, "yaw": 85.3, "yaw360": 85.3, "zoom": 40},
    {"pitch": -7.1, "yaw": 85.3, "yaw360": 85.3, "zoom": 40},

    {"pitch": -6.0, "yaw": 85.3, "yaw360": 85.3, "zoom": 40},
    {"pitch": -6.0, "yaw": 85.3, "yaw360": 85.3, "zoom": 40},

    {"pitch": -5.6, "yaw": 85.0, "yaw360": 85.0, "zoom": 40},
    {"pitch": -5.6, "yaw": 85.0, "yaw360": 85.0, "zoom": 40},

    {"pitch": -5.0, "yaw": 84.8, "yaw360": 84.8, "zoom": 40},
    {"pitch": -5.0, "yaw": 84.8, "yaw360": 84.8, "zoom": 40},

    {"pitch": -4.4, "yaw": 84.4, "yaw360": 84.4, "zoom": 80},
    {"pitch": -4.4, "yaw": 84.4, "yaw360": 84.4, "zoom": 80},

    {"pitch": -4.0, "yaw": 83.9, "yaw360": 83.9, "zoom": 80},
    {"pitch": -4.0, "yaw": 83.9, "yaw360": 83.9, "zoom": 80},

    {"pitch": -3.7, "yaw": 83.4, "yaw360": 83.4, "zoom": 80},
    {"pitch": -3.7, "yaw": 83.4, "yaw360": 83.4, "zoom": 80},

    {"pitch": -3.2, "yaw": 82.3, "yaw360": 82.3, "zoom": 80},
    {"pitch": -3.2, "yaw": 82.3, "yaw360": 82.3, "zoom": 80},

    {"pitch": -3.0, "yaw": 81.8, "yaw360": 81.8, "zoom": 80},
    {"pitch": -3.0, "yaw": 81.8, "yaw360": 81.8, "zoom": 80},

    {"pitch": -2.8, "yaw": 81.4, "yaw360": 81.4, "zoom": 80},
    {"pitch": -2.8, "yaw": 81.4, "yaw360": 81.4, "zoom": 80},

    {"pitch": -2.7, "yaw": 81.0, "yaw360": 81.0, "zoom": 80},
    {"pitch": -2.7, "yaw": 81.0, "yaw360": 81.0, "zoom": 80},

    {"pitch": -2.6, "yaw": 80.6, "yaw360": 80.6, "zoom": 160},
    {"pitch": -2.6, "yaw": 80.6, "yaw360": 80.6, "zoom": 160},

    {"pitch": -2.5, "yaw": 80.2, "yaw360": 80.2, "zoom": 160},
    {"pitch": -2.5, "yaw": 80.2, "yaw360": 80.2, "zoom": 160},

    {"pitch": -2.2, "yaw": 80.0, "yaw360": 80.0, "zoom": 160},
    {"pitch": -2.2, "yaw": 80.0, "yaw360": 80.0, "zoom": 160},

    {"pitch": -2.2, "yaw": 79.8, "yaw360": 79.8, "zoom": 160},
    {"pitch": -2.2, "yaw": 79.8, "yaw360": 79.8, "zoom": 160},

    {"pitch": -2.1, "yaw": 79.5, "yaw360": 79.5, "zoom": 160},
    {"pitch": -2.1, "yaw": 79.5, "yaw360": 79.5, "zoom": 160},

    {"pitch": -2.0, "yaw": 79.2, "yaw360": 79.2, "zoom": 160},
    {"pitch": -2.0, "yaw": 79.2, "yaw360": 79.2, "zoom": 160},

    {"pitch": -1.9, "yaw": 79.1, "yaw360": 79.1, "zoom": 160},
    {"pitch": -1.9, "yaw": 79.1, "yaw360": 79.1, "zoom": 160},

    {"pitch": -1.8, "yaw": 79.2, "yaw360": 79.2, "zoom": 160},
    {"pitch": -1.8, "yaw": 79.2, "yaw360": 79.2, "zoom": 160},
]

# ---------------------------
# NEW: Coordinates linked to each PAIR of gimbal entries (index // 2)
# These are the lat,lon lines you had inline previously.
# ---------------------------
...
model = YOLO(r"C:\Users\User\Downloads\Mobile-SDK-Android-V5-codex-update-python-script-for-gimbal-and-truck-detection\Mobile-SDK-Android-V5-codex-update-python-script-for-gimbal-and-truck-detection\scripts\best.pt")
...
# NEW: map a pose index to its linked coordinate (pair-aligned)
def get_linked_coord_for_pose(pose_index: int) -> Optional[Tuple[float, float]]:
    """Each pair of gimbal entries share one coord: coord_idx = pose_index // 2."""
    coord_idx = pose_index // 2
    if 0 <= coord_idx < len(PHOTO_COORDS):
        return PHOTO_COORDS[coord_idx]
    return None
...
def process_camera_poses(poses: Iterable[CameraPose]) -> None:
    ...
    # ===============================
    # STEP 5: Optional GStreamer pipeline (more robust). Otherwise use FFmpeg.
    # ===============================
    def _open_capture():
        if USE_GSTREAMER:
    ...
    # ===============================
    # STEP 3: Warm up reader until a keyframe (discard initial frames)
    # ===============================
    def read_stable_frame(cap, warmup=60):
        ok = False
        frame = None
    ...
    try:
        with socket.create_connection((HOST, PORT)) as sock:
            ...
            try:
                for index, pose in enumerate(poses):
                    ...
                    while time.time() - start_time <= DETECTION_TIMEOUT_SECONDS:
                        ...
                        if n_trucks >= TRUCK_MIN_COUNT:
                            ...
                            if coord is not None:
                                ...
                                # Fallback: try to fetch from controller
                                position = fetch_position(sock)
                                if position is None:
                                    print(
                                        "Trucks detected but coordinates unavailable; "
                    ...
                    # Save a 'no truck' frame for record keeping (unchanged)
                    if not pose_has_trucks:
                        if last_frame is not None:
                            # You can still tag with controller coords, or skip
                            position = fetch_position(sock)
                            if position is None:
                                print(
        ...
        # Just report if nothing matched the gating rule
        published_any = any(det.published for det in detections)
        if not published_any:
            print("No trucks (meeting the gating rule) were published.")
